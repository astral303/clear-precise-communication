...
`You` is a string the product prints. Quoting it in a commit or an MR description
...
Search the artifact for `you`, `your`. In a title, commit, MR description, issue or
