...
Merge request descriptions, issues, design docs, reviewer guides, plans, ADRs, and
...
- "This is chat, not the MR." If the chat text is the MR description, it is the MR description.
